...
import { useLanguage } from '@/components/templates/@common/languageContext'
			...
			<div className={'lg:block hidden'}>
				<div className={'flex flex-row items-center justify-between p-5 mx-[5em]'}>
					...
					<div className={'flex flex-row gap-[2em] items-center'}>
						...
						<Link href={'/about'} target={'_self'} className={''}>
							About Us
						</Link>
						<Link href={'/menu'} target={'_self'} className={''}>
							Menu
						</Link>
						<Link
					...
					<div className={'xs:w-[20em] w-[15em] h-[100vh] flex flex-col bg-[#F7F9FF] text-white'}>
						...
						<div className={'flex flex-col h-full justify-between'}>
							...
							<div
								...
								<select
									className={'p-2 bg-transparent text-black focus:outline-none text-[1em] cursor-pointer'}>
									<option value={'ind'}>Indonesia</option>
									<option value={'eng'}>English</option>
								</select>
							</div>
